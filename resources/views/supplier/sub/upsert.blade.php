        ...
        <form class="form-horizontal" role="form" method="POST" action="{{ url('/supplier/update') }}" enctype="multipart/form-data">
            ...
            <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                ...
                <div class="col-md-6">
                    ...
                    value="{{ old('name') ? old('name') : $supplier->name }}" required autofocus>
            ...
            <div class="form-group{{ $errors->has('chart_bg_color') ? ' has-error' : '' }}">
                ...
                <div class="col-md-6">
                    <input type="text" name="chart_bg_color" id="chart_bg_color" class="chart_bg_color jscolor {hash:true} form-control" value="{{ old('chart_bg_color') ? old('chart_bg_color') : $supplier->chart_bg_color }}">
            ...
            <div class="form-group{{ $errors->has('chart_bd_color') ? ' has-error' : '' }}">
                ...
                <div class="col-md-6">
                    <input type="text" name="chart_bd_color" id="chart_bd_color" class="chart_bd_color jscolor {hash:true} form-control" value="{{ old('chart_bd_color') ? old('chart_bd_color') : $supplier->chart_bd_color }}">    
